...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  project: {
    ...
    getPendingQuestion: () => ipcRenderer.invoke("project:getPendingQuestion"),
    answerAgentQuestion: (payload) => ipcRenderer.invoke("project:answerAgentQuestion", payload),
    ...
    listPlans: (projectId) => ipcRenderer.invoke("project:listPlans", projectId),
    savePlanV2: (payload) => ipcRenderer.invoke("project:savePlanV2", payload),
    deletePlanV2: (payload) => ipcRenderer.invoke("project:deletePlanV2", payload),
    setActivePlan: (payload) => ipcRenderer.invoke("project:setActivePlan", payload),
    archivePlan: (payload) => ipcRenderer.invoke("project:archivePlan", payload),
    executePlan: (payload) => ipcRenderer.invoke("project:executePlan", payload),
    savePlanFromChatMessage: (payload) => ipcRenderer.invoke("project:savePlanFromChatMessage", payload),
    ...
    onAgentQuestion: (callback) => subscribe("project:agentQuestion", callback),
    onAgentQuestionResolved: (callback) => subscribe("project:agentQuestionResolved", callback),
  },
  ...
  p2p: {
    ...
    isOwner: (payload) => ipcRenderer.invoke("p2p:isOwner", payload),
