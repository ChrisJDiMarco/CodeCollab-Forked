...
const copilotModelOptions = [
  ...
  { id: "claude-opus-4.5|low", label: "Claude Opus 4.5 (Reasoning: Low)", usage: "3x", provider: "Anthropic" },
  { id: "claude-opus-4.5|medium", label: "Claude Opus 4.5 (Reasoning: Medium)", usage: "3x", provider: "Anthropic" },
  { id: "claude-opus-4.5|high", label: "Claude Opus 4.5 (Reasoning: High)", usage: "3x", provider: "Anthropic" },
  ...
  { id: "o3|low", label: "o3 (Reasoning: Low)", usage: "1x", provider: "OpenAI" },
  { id: "o3|medium", label: "o3 (Reasoning: Medium)", usage: "1x", provider: "OpenAI" },
  { id: "o3|high", label: "o3 (Reasoning: High)", usage: "1x", provider: "OpenAI" },
  { id: "o4-mini|low", label: "o4-mini (Reasoning: Low)", usage: "0.33x", provider: "OpenAI" },
  { id: "o4-mini|medium", label: "o4-mini (Reasoning: Medium)", usage: "0.33x", provider: "OpenAI" },
  { id: "o4-mini|high", label: "o4-mini (Reasoning: High)", usage: "0.33x", provider: "OpenAI" },
  { id: "gemini-2.5-pro", label: "Gemini 2.5 Pro", usage: "1x", provider: "Google" },
  { id: "gemini-2.5-flash", label: "Gemini 2.5 Flash", usage: "0.33x", provider: "Google" },
  { id: "grok-code-fast-1", label: "Grok Code Fast 1", usage: "0.5x", provider: "xAI" },
];

const claudeCodeModelOptions = [
  { id: "sonnet", label: "Claude Sonnet 4.5 (Latest)", usage: "", provider: "Claude Code" },
  { id: "opus", label: "Claude Opus 4.5 (Latest)", usage: "", provider: "Claude Code" },
  { id: "haiku", label: "Claude Haiku 4.5 (Latest)", usage: "", provider: "Claude Code" },
                      ...
                      {desktopSettings?.featureFlags?.githubCopilotCli && (
                        <optgroup label="GitHub Copilot">
                          {copilotModelOptions.map((model) => (
                            <option key={model.id} value={model.id}>{[model.label, model.usage, model.provider].filter(Boolean).join(" — ")}</option>
                          ))}
                        </optgroup>
                      )}
                      {desktopSettings?.featureFlags?.claudeCode && (
                        <optgroup label="Claude Code">
                          {claudeCodeModelOptions.map((model) => (
                            <option key={model.id} value={model.id}>{[model.label, model.usage].filter(Boolean).join(" — ")}</option>
                          ))}
                        </optgroup>
                      )}
